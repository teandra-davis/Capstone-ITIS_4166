...
const { isLoggedIn, isAuthor, isGuest} = require('../middleware/auth');
const { validatorId, validateEvent, validateCategory, validateStartDate, validateEndDate } = require('../middleware/validator');
...
//Edited
router.post('/create', fileUpload, validateCategory, validateStartDate, validateEndDate, validateEvent, controller.create);
...
router.put('/:id', isLoggedIn, isAuthor, validatorId, validateCategory, validateStartDate, validateEndDate, validateEvent, fileUpload, controller.update);
